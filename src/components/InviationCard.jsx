...
const InvitationCard = () => {
    ...
    const handleConfirm = async () => {
        const response = await apiService.userConfirm(user._id);
                        ...
                        <div className="px-6 italic">
                            ...
                            <div className="mb-6">
                                ...
                                <p className="text-gray-700 leading-relaxed text-center mb-4">
                                    Nous avons l'honneur de vous inviter à une soirée exceptionnelle marquant la fin de cette année riche en projets et en réussites. Ce sera l'occasion de célébrer ensemble nos accomplissements et de partager un moment privilégié dans une atmosphère festive et raffinée.
                                </p>
                            </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-4 border border-purple-100">
                                ...
                                <p className="text-center text-gray-600 mt-2 mb-6">
                                    par retour de ce message.
                                </p>


                                {
                                    ticket?.used === false
                                        ? <div className="text-center w-full px-5 mt-5 py-3 text-gray-700 bg-red-50 font-medium rounded-xl flex-1 sm:flex-none">
                                            Invite une personne via ce lien
                                            <div className='text-green-700 text-xs hover:cursor-pointer' onClick={() => {
                                                copierTexte(`${window.location.protocol}//${window.location.host}/invitation/${user._id}/guest`)
                                            }}>{`${window.location.protocol}//${window.location.host}/invitation/${user._id}/guest`}</div>
                                        </div>
                                        : null
                                }
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">

                            {
                                user?.confirmInvitation === false
                                    ...
                                    : <span className="px-5 py-3 text-green-700 bg-green-50 font-medium rounded-xl flex-1 sm:flex-none">
                                        Présence confirmée
                                    </span>
                            }
